...
Data Description
----
In [Download_Data](https://github.com/Trenchant-ymz/Inferring-Passengers-Interactive-Choices/tree/master/Download_Data),<font color=red size=3>**Please refer to the link on the top of this page to download the released dataset.**</font>, we release our dataset. The released dataset was collected and processed by following steps.
